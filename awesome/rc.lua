...
modkey = "Mod1"
rofi_launch = "rofi -no-lazy-grab -show drun -modi run,drun,window -theme " .. home .. "/.config/rofi/default -drun-icon-theme \"candy-icons\" "
...
globalkeys = gears.table.join(
    awful.key({ modkey, }, "w", 
                function()
                    if beautiful.useless_gap > dpi(1) then
                        beautiful.useless_gap = dpi(1)
                        awful.spawn("cp " .. home .. "/.config/picom/square/picom.conf " .. home .. "/.config/picom")
                        awful.spawn("eww close top-panel")
                        awful.spawn("eww open work-top-panel")
                    else
                        beautiful.useless_gap = dpi(mygaps)
                        awful.spawn("cp " .. home .. "/.config/picom/round/picom.conf " .. home .. "/.config/picom")
                        awful.spawn("eww close work-top-panel")
                        awful.spawn("eww open top-panel")
                    end
              ...
              {description = "toggle zen", group="client"}),
